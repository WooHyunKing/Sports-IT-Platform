...
import Terms from "./pages/account/signup/terms/Terms";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/signup/terms" element={<Terms />}></Route>
        ...
        <Route path="/competition" element={<Competition />}>
          <Route path=":cpId" element={<CompetitionInfo />}>
            <Route path="apply" element={<CompetitionApply />}></Route>
          </Route>
        </Route>
        ...
        <Route path="/official-document" element={<OfficialDocument />}></Route>
      </Routes>
    </BrowserRouter>
  );
};
